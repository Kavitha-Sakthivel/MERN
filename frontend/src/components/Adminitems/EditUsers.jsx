...
import { patchUser } from "../../Redux/AdminReducer/action"; // Removed patchProduct
...
const EditUser = () => {
  ...
  // Ensure both _id and id are compared as strings
  const existedUser = store.filter((el) => String(el._id) === String(id)); 
